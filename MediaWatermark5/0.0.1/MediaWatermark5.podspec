...
s.homepage         = 'https://github.com/1986webdeveloper/MediaWatermark'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'Acquaint' => '1986webdeveloper@gmail.com' }
s.source           = { :git => 'https://github.com/1986webdeveloper/MediaWatermark.git', :tag => s.version.to_s }
